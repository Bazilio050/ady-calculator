...
def call_gemini_nlu(client, user_input_text, lang):
    ...
    prompt = (
        ...
        "- MAP SPECIFIC STATIONS ACCURATELY:\n"
        "  * 'баку-тов', 'баку тов', 'баку товарная', 'bakı-tov', 'bakı yük' -> 'Bakı-Yük'\n"
        "  * 'баку порт', 'bakı ticarət limanı' -> 'Bakı Ticarət Limanı'\n"
        "  * 'алят экспорт курык', 'курык', 'aktau', 'алят' -> 'Ələt'\n"
        "  * 'астара' -> 'Astara'\n"
