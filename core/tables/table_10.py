...
class Table10Calculator:
    """Вычислитель тарифных ставок Таблицы 10 (Специализированные контейнеры)"""
    ...
    def get_base_rate(
        ...
        """Возвращает базовую ставку в CHF по Таблице 10."""
        ...
        if container_type in ("wine", "wine_juice", "wine_juice_container"):
            col_key = f"wine_{feet_size}"
        elif container_type in ("ref", "reefer_container"):
