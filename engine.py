...
# ==============================================================================
# === [НАЧАЛО БЛОКА: ENGINE-01] Константы и форматирование кодов ГНГ ===
# Описание: Списки кодов порожнего приватного парка (EMPTY_SPS_CODES),
# вагонов на своих осях (OWN_AXLE_GNG_CODES) и функция доведения ГНГ до 8 цифр.
# ==============================================================================
...
# ==============================================================================
# === [НАЧАЛО БЛОКА: ENGINE-02] Проверка опасных и негабаритных грузов ===
# Описание: Функции сверки с Таблицей 13 ООН (check_dangerous_goods_rule)
# и определения степеней негабаритности (detect_oversize_group).
# ==============================================================================
...
# ==============================================================================
# === [НАЧАЛО БЛОКА: ENGINE-03] Валютный курс и фрахтовые периоды ===
# Описание: Считывание текущего или запрошенного курса CHF/USD за указанный период.
# ==============================================================================
...
# ==============================================================================
# === [НАЧАЛО БЛОКА: ENGINE-04] Расчёт надбавок, скидок СПС и индексаций ===
# Описание: Применение коэффициента 1.015, скидки СПС (0.85/0.70), коэффициент 1.50,
# вагон прикрытия, пассажирские поезда, длинные платформы (>19м) и спецтаблицы.
# ==============================================================================
...
def process_full_calculation(nlu_data: dict, user_input_raw: str = "", lang: str = "AZ", year: str = "2026", ui_t: dict = None, *args, **kwargs) -> dict:
    ...
    if has_ferry_kw or nlu_data.get("is_asco_ferry"):
        ...
        port_display_name = display_to
        asco_ferry_dict = {
            "line_title": f"ASCO Bərə daşıma haqqı ({port_display_name})",
